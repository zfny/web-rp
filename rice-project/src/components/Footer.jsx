...
export default function Footer() {
  return (
    <footer className="footer text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" style={{background: 'radial-gradient(circle at center, rgba(35,45,58,0.9) 0%, rgba(35,45,58,0.8) 25%, rgba(35,45,58,0.6) 50%, rgba(35,45,58,0.25) 70%, transparent 100%)'}} />
      <div className="footer-content relative z-10 flex flex-col items-center">
